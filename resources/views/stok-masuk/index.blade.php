...
@section('title', 'Stok Masuk - Inventory ATK')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('stok-masuk.create') }}" class="btn btn-success">
...
<div class="card">
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-success badge-stok">
                                <i class="bi bi-plus"></i> {{ $stok->jumlah }} {{ $stok->barang->satuan }}
                            </span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-4">
                            <div class="text-muted">
                                ...
                                <a href="{{ route('stok-masuk.create') }}">Tambah stok masuk</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
        ...
        <div class="mt-3">
            <small class="text-muted">Total: <strong>{{ $stokMasuks->count() }}</strong> transaksi</small>
        </div>
        @endif
    </div>
</div>
